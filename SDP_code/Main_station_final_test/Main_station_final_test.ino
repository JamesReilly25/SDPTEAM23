...
const int LED_PIN= 3; //led to arduino pin 2
...
const int PumpPin = 10;    // the number of the Pump control pin
...
void LCD_State_5(){
  lcd.clear();
  lcd.setCursor(0,0);
  lcd.print("State 5: which");
  lcd.setCursor(0,1);
  lcd.print("plants to water");
}

void LCD_Move_On(){
  lcd.clear();
  lcd.setCursor(0,0);
  String tempstring1 = "To go to state ";
  tempstring1 += (state+1);
  lcd.print(tempstring1);
  lcd.setCursor(0,1);
  lcd.print("hold button");
}
void LCD_Release_button(){
  lcd.clear();
  lcd.setCursor(0,0);
  String tempstring1 = "Release button";
  lcd.print(tempstring1);
  lcd.setCursor(0,1);
  lcd.print("now");
}
...
void loop() {
  ...
  if(buttonState == HIGH){
    ...
    Serial.println("release button to move one");
    LCD_Release_button();
    delay(2000);
  }
  buttonState = LOW;
